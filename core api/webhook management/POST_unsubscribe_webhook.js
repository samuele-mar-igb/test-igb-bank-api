...
const endpoint = "/v1/bank-api/webhook/unsubscribe"; 
const subscribeId = "03f8a264-6dd4-479d-8a03-347ae35e83b1";     // Change with real existing id!
const url = `https://${host}${endpoint}?subscribeId=${subscribeId}`;
